...
task :import_data => :environment do
    ...
    iSFtoPGTask.importEverything('admin@30df.org','Merc1243HGRcayiE38dzluu4LkACcfOjy','00DE0000000II8g')
    puts "done."
end
...
task :import_sadunya_data => :environment do
    ...
    iUnmanagedSFtoPGTask.importEverything('snehal.fulzele@91demo.com','mfiflex4321quRC8beUMWDkZsZKQA5RgCBx','00Dd0000000bxQO')
    puts "done."
end